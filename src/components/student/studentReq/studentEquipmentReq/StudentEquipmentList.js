                            ...
                            <div>
                                ...
                                <div >
                                    <div className='table__tabs'>
                                        <Link to="/chem/student-dashboard/student-chemicals-list" className='table__tab table__tab--chemicals table__tab--unactive'>รายการสารเคมี</Link>
                                                                ...
                                                                {isOffCanvasEnabled && (
                                                                    <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasWithBackdrop2" aria-labelledby="offcanvasWithBackdropLabel">
                                                                        <div className="offcanvas-header">
                                                                            ...
                                                                            <Link to="/chem/student-dashboard/student-equipment-cart" className="offcanvas--link">ไปที่ตระกร้าครุภัณฑ์</Link>
                                                                        </div>
