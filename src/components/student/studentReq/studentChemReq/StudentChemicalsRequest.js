            ...
            <div className='dashboard__container'>
                <aside className='sidebar'>
                    ...
                    <div className='sidebar__body'>
                        ...
                        <Link to="/chem/student-dashboard/student-chemicals-request" className='sidebar__item sidebar__item--hover'> <i className="fa-solid fa-clock-rotate-left" /> <div className='sidebar__item--active'>History</div></Link>
                        ...
                        <div>
                            ...
                            <div >
                                <div className='table__tabs'>
                                    ...
                                    <Link to="/chem/student-dashboard/student-equipment-request" className='table__tab table__tab--equipment table__tab--unactive'>ประวัติการเบิกครุภัณฑ์</Link>
                                </div>
