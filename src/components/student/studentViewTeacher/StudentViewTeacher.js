            ...
            <div className='dashboard__container'>
                <aside className='sidebar'>
                    ...
                    <div className='sidebar__body'>
                        ...
                        <Link to="/student-dashboard/student-view-teacher" className='sidebar__item sidebar__item--hover'> <i class="fa-solid fa-users" /> <div className='sidebar__item--active'>Teacher</div></Link>
                    </div>
