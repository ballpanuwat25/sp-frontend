                ...
                <div className='d-flex justify-content-between align-items-center'>
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <li><Link className="dropdown-item" to="/chemicals-log-activity">Chemicals Log Activity</Link> </li>
                            <li><Link className="dropdown-item" to="/equipment-log-activity">Equipment Log Activity</Link> </li>
                        </ul>
                    </div>
                </div>
            </div> <hr />
