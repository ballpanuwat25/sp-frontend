            ...
            <table className="table table-striped">
                ...
                <tbody>
                    {filteredLogActivity.map((logActivity) => (
                        (logActivity.Equipment_Id !== null && logActivity.Equipment_Id !== "") && (
                            <tr key={logActivity.LogActivity_Id}>
                                ...
                                <td> {logActivity.Equipment_Id} </td>
...
export default EquipmentLogActivity