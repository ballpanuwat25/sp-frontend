            ...
            <div className='dashboard__container'>
                <aside className='sidebar'>
                    ...
                    <div className='sidebar__body'>
                        ...
                        <Link Link to="/chem/chemicals-list" className='sidebar__item sidebar__item--hover'> <i className="fa-solid fa-flask" /> Chemicals</Link>
...
<Link to="/chem/approve-students-list" className='sidebar__item sidebar__item--hover'> <i className="fa-solid fa-users" /> Users</Link>
                        <Link to="/chem/staff-profile" className='sidebar__item sidebar__item--hover'> <i className="fa-regular fa-user" /> <div className='sidebar__item--active'> Profile</div></Link>
                    </div>
