...
function EditChemicalsDetail() {
    ...
    const getChemicalsDetailById = async () => {
        const response = await axios.get(`https://backup-test.onrender.com/chemicalsDetail-list/${id}`);
    ...
    const updateChemicalsDetail = async (e) => {
        e.preventDefault();
        const response = await axios.patch(`https://backup-test.onrender.com/chemicalsDetail-list/${id}`, {
            Chem_Id,
            Chem_Name,
            Chem_CAS,
            Chem_UN,
