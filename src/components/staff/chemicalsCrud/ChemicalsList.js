            ...
            <div className='dashboard__container'>
                <aside className='sidebar'>
                    ...
                    <div className='sidebar__body'>
                        ...
                        <Link to="/chem/chemicals-list" className='sidebar__item sidebar__item--hover'> <i className="fa-solid fa-flask" /> <div className='sidebar__item--active'> Chemicals</div></Link>
                        ...
                        <div>
                            <div className='component__header'>
                                <div className='component__headerGroup component__headerGroup--left'>
                                    ...
                                    <Link to="/chem/barcode-chemicals" className="btn btn-outline-success me-3"><i className="fa-solid fa-barcode"></i></Link>
                            ...
                            <div>
                                <div className='table__tabs'>
                                    ...
                                    <Link to="/chem/chemicalsDetail-list" className='table__tab table__tab--equipment table__tab--unactive'>สารเคมี</Link>
                                    <Link to="/chem/report-chemicals" className='table__tab table__tab--equipment table__tab--unactive'>ออกรายงาน</Link>
                                </div>
