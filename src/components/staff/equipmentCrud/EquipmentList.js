                        ...
                        <div>
                            <div className='component__header'>
                                <div className='component__headerGroup component__headerGroup--left'>
                                    ...
                                    <Link to="/chem/barcode-equipment" className="btn btn-outline-success me-3"><i className="fa-solid fa-barcode"></i></Link>
                            ...
                            <div>
                                <div className='table__tabs'>
                                    ...
                                    <Link to="/chem/equipmentCategory-list" className='table__tab table__tab--equipment table__tab--unactive'>หมวดหมู่ครุภัณฑ์</Link>
                                    <Link to="/chem/report-equipment" className='table__tab table__tab--equipment table__tab--unactive'>ออกรายงาน</Link>
                                </div>
