...
function EditEquipment({ logout }) {
    ...
    const getEquipmentById = async () => {
        const response = await axios.get(process.env.REACT_APP_API + `/equipment-list/${id}`);
    ...
    const updateEquipment = async (e) => {
        ...
        const response = await axios.patch(process.env.REACT_APP_API + `/equipment-list/${id}`, {
            Equipment_Id,
                ...
                <main className='dashboard__content'>
                    ...
                    <form onSubmit={updateEquipment}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="number" min="0" className="profile__input" id="Quantity" placeholder="Enter Quantity" required
                                onChange={(e) => {
