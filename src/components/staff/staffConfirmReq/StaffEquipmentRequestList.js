                        ...
                        <div>
                            ...
                            <div>
                                <div className='table__tabs'>
                                    <Link to="/chem/staff-dashboard/staff-chemicals-request-list" className='table__tab table__tab--chemicals table__tab--unactive'>คำขอเบิกสารเคมี</Link>
                                            ...
                                            <tr key={equipmentReq.Equipment_Request_Id} className="active-row">
                                                ...
                                                <td>
                                                    <div className="d-grid gap-2 d-sm-flex">
                                                        <Link to={`/chem/staff-dashboard/staff-equipment-request/${equipmentReq.Equipment_Request_Id}`} className='disable--link thai--font'>
