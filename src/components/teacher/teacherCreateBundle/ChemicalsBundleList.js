            ...
            <div className='dashboard__container'>
                <aside className='sidebar'>
                    ...
                    <div className='sidebar__body'>
                        ...
                        <Link to="/chem/teacher-dashboard/chemicals-bundle-list" className='sidebar__item sidebar__item--hover'> <i className="fa-solid fa-list" /> <div className='sidebar__item--active'>List</div></Link>
                        ...
                        <div>
                            ...
                            <div>
                                <div className='table__tabs'>
                                    ...
                                    <Link to="/chem/teacher-dashboard/equipment-bundle-list" className='table__tab table__tab--equipment table__tab--unactive'>รายการครุภัณฑ์</Link>
                                </div>
